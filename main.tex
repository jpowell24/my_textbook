...
Norepinepherine is a tyrosine derivative and, like other catecholamines, can be broken down either by monoamine oxidase (MOA) in the neuron's mitochondria, requiring re-uptake, or in the liver by catechol-o-methyltransferase (COMT).\newline
...
\section{Electrostimultaion and Accompanying Cells}
...
\begin{enumerate}
    \item Inhibit L-type VGCCs
    \item Optimize stiffness of paddles
    \item Optimize ECoG
\end{enumerate}
