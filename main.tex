...
Implanted devices naturally allow for more control, and a significant improvement came in 2006 when the Donoghue group allowed for prosthetic device control upon implanting a 100 electrode device. In 2015, the Henderson lab showed that an implanted neural prosthesis could be used to generate speech in an ALS patient. 
...
This effectively concludes our discussion of neurodegenerative diseases. It seems we are leagues away from having all questions answers. Indeed, some of the most fundamental concepts, like the true role of neurons, and the importance of aggregates, are still not known. Let us hope that in the coming years, landmark studies help clear up these misconceptions so we can get to the heart of disease. Perhaps these landmark studies will be done by you. Best of luck. 
