...
\begin{titlepage}
   ...
   \begin{center}
       ...
       \textbf{\Large{Forcing a meaninful future: Brain-spine-muscle interfaces\\
       \smallskip }}
...
It is true that total recovery from spinal cord injury, in sever cases, will require both therapeutic and electronic intervention. 
...
\part[Brain-Spine Interfaces]{Brain-Spine Interfaces
            \vspace{0.2in}
            \begin{center}
            \begin{minipage}[l]{10cm}\small
