...
Inhibiting the Nogo receptor, such as by NogoA antibodies promotes growth. \\

Promotion or delivery of chondroitinase ABS promotes plasticity and growth. \\

Inhibiting protein tyrosine phosphatase $\sigma$ enhances serotonergic axon recovery and fuctional outcomes. \\
...
Pharmacological promotion of axon regeneration has inherent limitations. For example, the canonical player PTEN (discussed in other sections) has shown robust regeneration, capable of penetrating the astrocytic border, but only in certain neuronal populations. Too, even in this case neurons abruptly halt when reaching the fibrotic scar. Somehow, one must induce global, or brilliantly targeted, growth to achieve true functional recovery. \newline
...
If, someday, you decide to become truly big, you should read \href{https://www.cell.com/neuron/fulltext/S0896-6273(23)00341-0}{this paper} as well.
...
\section{Non-coding RNA in Rewiring}
...
This section will cover some of the basic, in a broad overview manner. Complex research, such as the discussion of stem cells and the research surrounding them, will be covered in a different section. \newline
...
-- I alreay read this, but looking back I feel I did not read it in the depth that it deserves: \url{https://www.nature.com/articles/s41582-019-0280-3}
...
\subsubsection{Clinic: Reduction of Pain.}
...
\subsubsection{Clinic: Regaining Motor Control.}
