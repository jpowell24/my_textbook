...
This is one way to go about this problem. Another way, which will be discussed in a different section, is using impedance. 
...
This is the equivalent of Ohm's law, where ${1} /{j\omega C}$ is the resistance. 
