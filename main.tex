...
Here I'll discuss some of the literature surrounding fluid mechanics and neuroscience. A large topic is the flow of CSF inside the brain and spinal cord, which has implications in drug delivery and hydrocephalus. Other notable topics include the application of shear stress to neurons, which may activate mechanically gated channels. 


Here I'll discuss\footnote{\url{https://www.cambridge.org/core/journals/journal-of-fluid-mechanics/article/onedimensional-model-for-the-pulsating-flow-of-cerebrospinal-fluid-in-the-spinal-canal/3710D122EC70FCB29DEF0AB196ADCCCD}}. The Sanchez group at UCSD has many papers on this topic, so their works are a great resource for further learning.\newline

The specific focus of this work is on intracranial pressure (ICP). 
...
\textcolor{red}{Why do they think this is integrated into the hosts at all? I don't get it?---many open questions. Their work has all been in oocytes, right? Can't it be that this protein is just integrated into the bacterial membrane and helps regulate bacterial osmolarity?}
