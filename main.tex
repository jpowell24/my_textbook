...
\texttt{O} here evaluates to \texttt{A} or \texttt{B} depending on if \texttt{S} (select) is 1 or 0.\newline
...
Pruisner would go on to win the Nobel Prize in just the next year. It took years for fully synthetic prions to be made and verified, which all but verified the protein only hypothesis.\newline

Meanwhile, Parkinson's disease started becoming treated with implantation of dopaminergic neurons into the third ventricle. Indeed, this helps alleviate some of the PD symptoms. Fascinatingly, though, afterwards the tissue was examined and shocking there was aggregates within the transplanted tissue. Therefore, it's thought that propagation of the disease causing protein, $\alpha$-synuclein, was acting in a prion-like manner. But, it is not a prion disease. How this can be reconcilled will be... discussed later. 
...
We are digressing now to Parkinson's disease. PD is indeed the second most common neurodegenerative disease, behind only AD. Parkinson's is characterized by Lewy body accumulation, first characterized in 1923. Notably, though, other diseases are characterized by Lewy body formation, like Lewy body dementia. In PD, the substantia nigra is one of the most strongly effected regions of the brain. Lewy bodies were found to stain for $\alpha$-synuclein, a protein which will form fibrils in vitro.\newline

Braak proposed a timecourse for PD where disease seemed to propagate out from the central regions of the brain. It was not clear how credible this description was, as it was initially based on a very small sample size.\newline

Notably, it was originally thought that PD was strictly sporadic, and that there was no genetic component. We now know, of course, that this is untrue. For a disease to be cleanly classified as PD, it requires both symptoms and the Lewy body pathology. A lack of Lewy bodies thus dubs the disease ``Parkinsonism." Recessive genes often result in Parkinsonism, where disease progression may be slower and less severe.\newline

In \textit{Drosophila}, loss of function in mutations like Parkin and Pink1 result in mitochondrial dysfunction. It's thought that PD may impact mitophagy and or mitochondrial turnover (see section \textbf{\ref{sec:MitochondrialMaintenance}}).\newline

Fascinatingly, great insight came from drug addiction in 1982. Synthetic heroin was being made, which resulted in a side product being produced called MPTP. Remarkably, this compound was taken up specifically by dopaminergic neurons in the substantia nigra, and killed them almost immediately. Therefore, these addicts immediately got PD. This has become a very helpful way to generate PD models.\newline

Because treatments like L-dopa have been successful in treating PD, one began to wonder if grafting in dopaminergic neurons would be successful...\newline

Such investigations take a considerable amount of time, and brain tissue could only be analyzed on the order of 10-15 years after grafting. The tissue was taken from fetuses, therefore eliminating the chance of natural PD arising in the grafted neurons. Still, shockingly, Lewy bodies were found in these grafted neurons. This was the first suggestion that Lewy bodies could, somehow, transfer from neuron to neuron.\newline

Braak's investigations went beyond just $\alpha-$syn. Similarly seen things existed for tau. Tau is a hallmark of many different diseases, called tauopathies, and examples include CTE, Pick's diseases, and, canonically, AD. This suggests, that like with prions, tau exhibits different strains that can spread and confer different diseases. Importantly, it does not seem that tauopathies are transmissible like prion diseases. Indeed, some of the greatest PD models, which came from the Virginia Lee group, were from injecting human $\alpha$-syn into mice. Prion researchers disagree that these are prion diseases, specifically because they are not transmissible, so some call it ``trans-synaptic spreading" diseases instead. 
